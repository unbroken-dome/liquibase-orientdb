...
public class OrientJdbcResultSetWrapper implements ResultSet {

    private final ResultSet delegate;


    public OrientJdbcResultSetWrapper(ResultSet delegate) {
    ...
    public int getInt(int columnIndex) throws SQLException {
        try {
            ...
            Long result = delegate.getLong(columnIndex);
    ...
    public int getInt(String columnLabel) throws SQLException {
        try {
            ...
            Long result = delegate.getLong(columnLabel);
            return result.intValue();
        }
    }


    /* All remaining methods just delegate to the wrapped ResultSet */
    ...
    public boolean relative(int iRows) throws SQLException {
        return delegate.relative(iRows);
    }


    @Override
    public boolean absolute(int iRowNumber) throws SQLException {
        return delegate.absolute(iRowNumber);
    }
